...
public class DepartementController {
    ...
    public String editerDepartement(@RequestParam("id") Long id, ModelMap modelMap , @RequestParam(value = "page", defaultValue = "0") int page, @RequestParam(value = "size", defaultValue = "3") int size) {
...
//    public String saveCollege(@ModelAttribute("College") College college, BindingResult bindingResult,
